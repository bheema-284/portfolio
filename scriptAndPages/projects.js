...
<!-- Cricbuzz project -->
            <div class="eachProjectDiv">
                <p class="ProjectName">Cricbuzz </p>
                <div class="ProjectContainer">
                    <div class="ProjectImage">
                        <img src="./images/crichome.PNG" alt="" />
                    </div>
       ...
       <p> <i class="fab fa-node-js"></i>
        NodeJs</p>
                        ...
                        <div class="ProjectLinks">
                            <a href="https://github.com/bheema-284/cricbuzz"
                                target="blank"><button>
                                    Github</button></a>
                            <a href="https://newcricbuzzcb.netlify.app/" target="blank"><button>Demo</button></a>
                           
 <a href="https://medium.com/@bheemudug/cloning-cricbuzz-595b1b2e5694" target="blank"><button>Blog</button></a>
                        </div>
                    </div>
                </div>
            </div>
